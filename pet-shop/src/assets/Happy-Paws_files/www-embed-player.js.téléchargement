...
function ta(a,b){a.l={rb:b,wb:!0};a.i=a.o||a.s}
...
function ya(a){a.o=0;var b=a.l.rb;a.l=null;return b}
function za(a){a.B=[a.l];a.o=0;a.s=0}
function Aa(a){var b=a.B.splice(0)[0];(b=a.l=a.l||b)?b.wb?a.i=a.o||a.s:void 0!=b.u&&a.s<b.u?(a.i=b.u,a.l=null):a.i=a.s:a.i=0}
...
function Ga(a){for(;a.i.i;)try{var b=a.j(a.i);if(b)return a.i.D=!1,{value:b.value,done:!1}}catch(c){a.i.j=void 0,ta(a.i,c)}a.i.D=!1;if(a.i.l){b=a.i.l;a.i.l=null;if(b.wb)throw b.rb;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
var f=new c;b.prototype.da=function(g){var h=this.m();g.Ga(h.resolve,h.reject)};
...
this.Ga(k(g,m),k(h,p));return u};
b.prototype.catch=function(g){return this.then(void 0,g)};
b.prototype.Ga=function(g,h){function k(){switch(m.i){case 1:g(m.l);break;case 2:h(m.l);break;default:throw Error("Unexpected state: "+m.i);}}
var m=this;null==this.j?f.j(k):this.j.push(k);this.D=!0};
b.resolve=d;b.reject=function(g){return new b(function(h,k){k(g)})};
b.race=function(g){return new b(function(h,k){for(var m=q(g),p=m.next();!p.done;p=m.next())d(p.value).Ga(h,k)})};
b.all=function(g){var h=q(g),k=h.next();return k.done?d([]):new b(function(m,p){function u(E){return function(F){y[E]=F;v--;0==v&&m(y)}}
var y=[],v=0;do y.push(void 0),v++,d(k.value).Ga(u(y.length-1),p),k=h.next();while(!k.done)})};
return b});
...
function Ma(a){a.Za=void 0;a.getInstance=function(){return a.Za?a.Za:a.Za=new a}}
...
c.prototype=b.prototype;a.Y=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.cp=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
function Za(a){return a}
;function $a(a,b){if(Error.captureStackTrace)Error.captureStackTrace(this,$a);else{var c=Error().stack;c&&(this.stack=c)}a&&(this.message=String(a));void 0!==b&&(this.Mb=b)}
...
;var Mc="undefined"!==typeof Uint8Array;var Nc="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol(void 0):void 0;function Oc(a,b){Object.isFrozen(a)||(Nc?a[Nc]|=b:void 0!==a.Ka?a.Ka|=b:Object.defineProperties(a,{Ka:{value:b,configurable:!0,writable:!0,enumerable:!1}}))}
function Pc(a){var b;Nc?b=a[Nc]:b=a.Ka;return null==b?0:b}
...
var Xc,Yc=Object.freeze(Qc([]));function Zc(a){if(Rc(a.G))throw Error("Cannot mutate an immutable Message");}
...
Qc(e):d[a]=Yc}}
rd.prototype.toJSON=function(){var a=this.G;return Xc?a:dd(a,hd)};
...
;function zd(a){this.j=!1;var b=a.program;a=a.globalName;var c=new yd;this.l=c.promise;this.m=q((0,x[a].a)(b,function(d,e){Promise.resolve().then(function(){c.resolve({Lb:d,uc:e})})},!0)).next().value;
this.tc=c.promise.then(function(){})}
zd.prototype.snapshot=function(a){if(this.j)throw Error("Already disposed");return this.l.then(function(b){var c=b.Lb;return new Promise(function(d){c(function(e){d(e)},[a.mb,
a.vc])})})};
zd.prototype.dispose=function(){this.j=!0;this.l.then(function(a){(a=a.uc)&&a()})};
...
return a}
var Nd={Mc:"allow-forms",Nc:"allow-modals",Oc:"allow-orientation-lock",Pc:"allow-pointer-lock",Qc:"allow-popups",Rc:"allow-popups-to-escape-sandbox",Sc:"allow-presentation",Tc:"allow-same-origin",Uc:"allow-scripts",Vc:"allow-top-navigation",Wc:"allow-top-navigation-by-user-activation"},Pd=cb(function(){return Od()});
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var m,p;a();return{reset:a,update:c,digest:d,Pb:function(){for(var u=d(),y="",v=0;v<u.length;v++)y+="0123456789ABCDEF".charAt(Math.floor(u[v]/16))+"0123456789ABCDEF".charAt(u[v]%16);return y}}}
...
function ee(a){var b=be();b.update(a);return b.Pb().toLowerCase()}
;var fe={};function ge(a){this.i=a||{cookie:""}}
l=ge.prototype;l.isEnabled=function(){if(!x.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{Ma:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
l.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.tp;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Ma}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.i.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
l.remove=function(a,b,c){var d=void 0!==this.get(a);this.set(a,"",{Ma:0,path:b,domain:c});return d};
l.Wa=function(){return he(this).keys};
...
function se(a,b){b||(b={});b[ue(a)]=!0;var c=a.stack||"";(a=a.Mb)&&!b[ue(a)]&&(c+="\nCaused by: ",a.stack&&0==a.stack.indexOf(a.toString())||(c+="string"===typeof a?a:a.message+"\n"),c+=se(a,b));return c}
...
we.prototype.preventDefault=function(){we.Y.preventDefault.call(this);var a=this.j;a.preventDefault?a.preventDefault():a.returnValue=!1};var ye="closure_listenable_"+(1E6*Math.random()|0);var ze=0;function Ae(a,b,c,d,e){this.listener=a;this.proxy=null;this.src=b;this.type=c;this.capture=!!d;this.Ja=e;this.key=++ze;this.wa=this.Fa=!1}
function Be(a){a.wa=!0;a.listener=null;a.proxy=null;a.src=null;a.Ja=null}
;function Ce(a){this.src=a;this.listeners={};this.i=0}
Ce.prototype.add=function(a,b,c,d,e){var f=a.toString();a=this.listeners[f];a||(a=this.listeners[f]=[],this.i++);var g=De(a,b,d,e);-1<g?(b=a[g],c||(b.Fa=!1)):(b=new Ae(b,this.src,f,!!d,e),b.Fa=c,a.push(b));return b};
...
function De(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.wa&&f.listener==b&&f.capture==!!c&&f.Ja==d)return e}return-1}
...
function Pe(a,b){if(a.wa)a=!0;else{b=new we(b,this);var c=a.listener,d=a.Ja||a.src;a.Fa&&Re(a);a=c.call(d,b)}return a}
...
function Ve(a,b,c,d){b=a.m.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.wa&&g.capture==c){var h=g.listener,k=g.Ja||g.src;g.Fa&&Ee(a.m,g);e=!1!==h.call(k,d)&&e}}return e&&!d.defaultPrevented}
;function We(a){Te.call(this);var b=this;this.B=this.l=0;this.T=null!=a?a:{M:function(e,f){return setTimeout(e,f)},
S:clearTimeout};var c,d;this.j=null!=(d=null==(c=window.navigator)?void 0:c.onLine)?d:!0;this.o=function(){return w(function(e){return t(e,Xe(b),0)})};
...
We.prototype.dispose=function(){window.removeEventListener("offline",this.o);window.removeEventListener("online",this.o);this.T.S(this.B);delete We.i};
We.prototype.H=function(){return this.j};
function Ye(a){a.B=a.T.M(function(){var b;return w(function(c){if(1==c.i)return a.j?(null==(b=window.navigator)?0:b.onLine)?c.u(3):t(c,Xe(a),3):t(c,Xe(a),3);Ye(a);c.i=0})},3E4)}
...
;var af={Pg:"EMBEDDED_PLAYER_MODE_UNKNOWN",Mg:"EMBEDDED_PLAYER_MODE_DEFAULT",Og:"EMBEDDED_PLAYER_MODE_PFP",Ng:"EMBEDDED_PLAYER_MODE_PFL"},bf={Mo:"WEB_DISPLAY_MODE_UNKNOWN",Io:"WEB_DISPLAY_MODE_BROWSER",Ko:"WEB_DISPLAY_MODE_MINIMAL_UI",Lo:"WEB_DISPLAY_MODE_STANDALONE",Jo:"WEB_DISPLAY_MODE_FULLSCREEN"};function cf(){this.data_=[];this.i=-1}
...
if("undefined"!==typeof a&&!B("Trident")&&!B("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(void 0!==c.next){c=c.next;var e=c.kb;c.kb=null;e()}};
return function(e){d.next={kb:e};d=d.next;b.port2.postMessage(0)}}return function(e){x.setTimeout(e,0)}}
...
l.forEach=function(a,b){for(var c=this.Wa(),d=0;d<c.length;d++){var e=c[d],f=this.get(e);a.call(b,f,e,this)}};
...
;function Mf(a){var b=[];Pf(new Qf,a,b);return b.join("")}
function Qf(){}
...
;function Zi(a,b,c,d,e){ie.set(""+a,b,{Ma:c,path:"/",domain:void 0===d?"youtube.com":d,secure:void 0===e?!1:e})}
function $i(a){return ie.get(""+a,void 0)}
function aj(){if(!ie.isEnabled())return!1;if(!ie.isEmpty())return!0;ie.set("TESTCOOKIESENABLED","1",{Ma:60});if("1"!==ie.get("TESTCOOKIESENABLED"))return!1;ie.remove("TESTCOOKIESENABLED");return!0}
...
function pj(){return{innertubeApiKey:L("INNERTUBE_API_KEY"),innertubeApiVersion:L("INNERTUBE_API_VERSION"),Ya:L("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),tb:L("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),Tb:L("INNERTUBE_CONTEXT_CLIENT_NAME",1),innertubeContextClientVersion:L("INNERTUBE_CONTEXT_CLIENT_VERSION"),vb:L("INNERTUBE_CONTEXT_HL"),ub:L("INNERTUBE_CONTEXT_GL"),Ub:L("INNERTUBE_HOST_OVERRIDE")||"",Wb:!!L("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),Vb:!!L("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1),appInstallData:L("SERIALIZED_CLIENT_CONFIG_DATA")}}
function qj(a){var b={client:{hl:a.vb,gl:a.ub,clientName:a.tb,clientVersion:a.innertubeContextClientVersion,configInfo:a.Ya}};navigator.userAgent&&(b.client.userAgent=String(navigator.userAgent));var c=x.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=Ph();""!==c&&(b.client.experimentsToken=c);c=Qh();0<c.length&&(b.request={internalExperimentFlags:c});rj(a,void 0,b);sj(void 0,b);tj(a,void 0,b);uj(void 0,b);L("DELEGATED_SESSION_ID")&&!M("pageid_as_header_web")&&(b.user={onBehalfOfUser:L("DELEGATED_SESSION_ID")});
...
function rj(a,b,c){a=a.tb;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=md(b,Fg,96)||new Fg;var d=Yi();d=Object.keys(bf).indexOf(d);d=-1===d?null:d;null!==d&&C(c,3,d);D(b,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=Yi())}
...
function wj(a,b,c){c=void 0===c?{}:c;var d={};M("enable_web_eom_visitor_data")&&L("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":L("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||L("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.bp||L("AUTHORIZATION"))||(a?b="Bearer "+A("gapi.auth.getToken")().ap:b=me([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=L("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return d}
...
a);
if("AbortError"===e.name)return new kk("UNKNOWN_ABORT",a,e.message);e.args=[Object.assign({},a,{name:"IdbError",zb:e.name})];e.level="WARNING";return e}
...
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.blocked,k=c.blocking,m=c.xc,p=c.upgrade,u=c.closed,y;g.addEventListener("upgradeneeded",function(v){try{if(null===v.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");v.dataLoss&&"none"!==v.dataLoss&&Zj("IDB_DATA_CORRUPTED",{reason:v.dataLossMessage||"unknown reason",dbName:dk(a)});var E=f(),F=new Hk(g.transaction);
...
function Yk(a){function b(){var f,g,h,k,m,p,u,y,v,E;return w(function(F){switch(F.i){case 1:return g=null!=(f=Error().stack)?f:"",wa(F,2),t(F,a.l(a.name,a.options.version,d),4);case 4:h=F.j;for(var H=a.options,R=[],O=q(Object.keys(H.va)),S=O.next();!S.done;S=O.next()){S=S.value;var ja=H.va[S],N=void 0===ja.fc?Number.MAX_VALUE:ja.fc;!(h.i.version>=ja.Ta)||h.i.version>=N||h.i.objectStoreNames.contains(S)||R.push(S)}k=R;if(0===k.length){F.u(5);break}m=Object.keys(a.options.va);p=h.objectStoreNames();
...
closed:c,xc:c,upgrade:a.options.upgrade};var e=b();a.i=e;return a.i}
;var Zk=new Vk("YtIdbMeta",{va:{databases:{Ta:1}},upgrade:function(a,b){b(1)&&Ek(a,"databases",{keyPath:"actualName"})}});
...
this.na=function(){};
this.now=Date.now;this.ta=!1;var b;this.Gb=null!=(b=a.Gb)?b:100;var c;this.Eb=null!=(c=a.Eb)?c:1;var d;this.Cb=null!=(d=a.Cb)?d:2592E6;var e;this.Ab=null!=(e=a.Ab)?e:12E4;var f;this.Db=null!=(f=a.Db)?f:5E3;var g;this.A=null!=(g=a.A)?g:void 0;this.Ia=!!a.Ia;var h;this.Ha=null!=(h=a.Ha)?h:.1;var k;this.Oa=null!=(k=a.Oa)?k:10;a.handleError&&(this.handleError=a.handleError);a.na&&(this.na=a.na);a.ta&&(this.ta=a.ta);this.F=a.F;this.T=a.T;this.K=a.K;this.J=a.J;this.ba=a.ba;this.eb=a.eb;this.cb=a.cb;this.A&&
(!this.F||this.F("networkless_logging"))&&xl(this)}
function xl(a){a.A&&!a.ta&&(a.i=!0,a.Ia&&Math.random()<=a.Ha&&a.K.Nb(a.A),yl(a),a.J.H()&&a.ya(),a.J.U(a.eb,a.ya.bind(a)),a.J.U(a.cb,a.jb.bind(a)))}
l=wl.prototype;l.writeThenSend=function(a,b){var c=this;b=void 0===b?{}:b;if(this.A&&this.i){var d={url:a,options:b,timestamp:this.now(),status:"NEW",sendCount:0};this.K.set(d,this.A).then(function(e){d.id=e;c.J.H()&&zl(c,d)}).catch(function(e){zl(c,d);
Al(c,e)})}else this.ba(a,b)};
l.sendThenWrite=function(a,b,c){var d=this;b=void 0===b?{}:b;if(this.A&&this.i){var e={url:a,options:b,timestamp:this.now(),status:"NEW",sendCount:0};this.F&&this.F("nwl_skip_retry")&&(e.skipRetry=c);if(this.J.H()||this.F&&this.F("nwl_aggressive_send_then_write")&&!e.skipRetry){if(!e.skipRetry){var f=b.onError?b.onError:function(){};
b.onError=function(g,h){return w(function(k){if(1==k.i)return t(k,d.K.set(e,d.A).catch(function(m){Al(d,m)}),2);
f(g,h);k.i=0})}}this.ba(a,b,e.skipRetry)}else this.K.set(e,this.A).catch(function(g){d.ba(a,b,e.skipRetry);
Al(d,g)})}else this.ba(a,b,this.F&&this.F("nwl_skip_retry")&&c)};
...
d.options.onSuccess=function(g,h){void 0!==d.id?c.K.ma(d.id,c.A):e=!0;c.J.aa&&c.F&&c.F("vss_network_hint")&&c.J.aa(!0);f(g,h)};
this.ba(d.url,d.options);this.K.set(d,this.A).then(function(g){d.id=g;e&&c.K.ma(d.id,c.A)}).catch(function(g){Al(c,g)})}else this.ba(a,b)};
l.ya=function(){var a=this;if(!this.A)throw pk("throttleSend");this.j||(this.j=this.T.M(function(){var b;return w(function(c){if(1==c.i)return t(c,a.K.sb("NEW",a.A),2);if(3!=c.i)return b=c.j,b?t(c,zl(a,b),3):(a.jb(),c.return());a.j&&(a.j=0,a.ya());c.i=0})},this.Gb))};
l.jb=function(){this.T.S(this.j);this.j=0};
function zl(a,b){var c,d;return w(function(e){switch(e.i){case 1:if(!a.A)throw c=pk("immediateSend"),c;if(void 0===b.id){e.u(2);break}return t(e,a.K.Xb(b.id,a.A),3);case 3:(d=e.j)?b=d:a.na(Error("The request cannot be found in the database."));case 2:if(Bl(a,b,a.Cb)){e.u(4);break}a.na(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.u(5);break}return t(e,a.K.ma(b.id,a.A),5);case 5:return e.return();case 4:b.skipRetry||(b=Cl(a,b));if(!b){e.u(0);break}if(!b.skipRetry||
void 0===b.id){e.u(8);break}return t(e,a.K.ma(b.id,a.A),8);case 8:a.ba(b.url,b.options,!!b.skipRetry),e.i=0}})}
function Cl(a,b){if(!a.A)throw pk("updateRequestHandlers");var c=b.options.onError?b.options.onError:function(){};
b.options.onError=function(e,f){var g,h,k;return w(function(m){switch(m.i){case 1:g=Dl(f);if(!(a.F&&a.F("nwl_consider_error_code")&&g||a.F&&!a.F("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.Oa)){m.u(2);break}if(!a.J.ca){m.u(3);break}return t(m,a.J.ca(),3);case 3:if(a.J.H()){m.u(2);break}c(e,f);if(!a.F||!a.F("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){m.u(6);break}return t(m,a.K.fb(b.id,a.A,!1),6);case 6:return m.return();case 2:if(a.F&&a.F("nwl_consider_error_code")&&
!g&&a.potentialEsfErrorCounter>a.Oa)return m.return();a.potentialEsfErrorCounter++;if(void 0===(null==(k=b)?void 0:k.id)){m.u(8);break}return b.sendCount<a.Eb?t(m,a.K.fb(b.id,a.A),12):t(m,a.K.ma(b.id,a.A),8);case 12:a.T.M(function(){a.J.H()&&a.ya()},a.Db);
case 8:c(e,f),m.i=0}})};
var d=b.options.onSuccess?b.options.onSuccess:function(){};
b.options.onSuccess=function(e,f){var g;return w(function(h){if(1==h.i)return void 0===(null==(g=b)?void 0:g.id)?h.u(2):t(h,a.K.ma(b.id,a.A),2);a.J.aa&&a.F&&a.F("vss_network_hint")&&a.J.aa(!0);d(e,f);h.i=0})};
return b}
function Bl(a,b,c){b=b.timestamp;return a.now()-b>=c?!1:!0}
function yl(a){if(!a.A)throw pk("retryQueuedRequests");a.K.sb("QUEUED",a.A).then(function(b){b&&!Bl(a,b,a.Ab)?a.T.M(function(){return w(function(c){if(1==c.i)return void 0===b.id?c.u(2):t(c,a.K.fb(b.id,a.A),2);yl(a);c.i=0})}):a.J.H()&&a.ya()})}
function Al(a,b){a.Ib&&!a.J.H()?a.Ib(b):a.handleError(b)}
...
Fl.prototype.toString=function(){return this.topic};var Gl=A("ytPubsub2Pubsub2Instance")||new K;K.prototype.subscribe=K.prototype.subscribe;K.prototype.unsubscribeByKey=K.prototype.ra;K.prototype.publish=K.prototype.ha;K.prototype.clear=K.prototype.clear;z("ytPubsub2Pubsub2Instance",Gl);var Hl=A("ytPubsub2Pubsub2SubscribedKeys")||{};z("ytPubsub2Pubsub2SubscribedKeys",Hl);var Il=A("ytPubsub2Pubsub2TopicToKeys")||{};z("ytPubsub2Pubsub2TopicToKeys",Il);var Jl=A("ytPubsub2Pubsub2IsAsync")||{};z("ytPubsub2Pubsub2IsAsync",Jl);
...
u.update(k)))})}),3);
c.yc=P();Yl(c);return m.return(k)})}
function $l(a,b){var c;return w(function(d){if(1==d.i)return t(d,Wl(b),2);c=d.j;return d.return(Dk(c,["LogsRequestsStore"],{mode:"readwrite",O:!0},function(e){var f=e.objectStore("LogsRequestsStore");return f.get(a).then(function(g){if(g)return g.status="QUEUED",Ak(f.i.put(g,void 0)).then(function(){return g})})}))})}
...
function cm(a){var b,c;return w(function(d){if(1==d.i)return t(d,Wl(a),2);b=d.j;c=P()-2592E6;return t(d,Dk(b,["LogsRequestsStore"],{mode:"readwrite",O:!0},function(e){return Mk(e.objectStore("LogsRequestsStore"),{},function(f){if(f.getValue().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
...
;var em={},fm=Tl("ServiceWorkerLogsDatabase",{va:(em.SWHealthLog={Ta:1},em),gb:!0,upgrade:function(a,b){b(1)&&Ek(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).i.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
version:1});function gm(a){return Xk(fm(),a)}
function hm(a){var b,c;return w(function(d){if(1==d.i)return t(d,gm(a),2);b=d.j;c=P()-2592E6;return t(d,Dk(b,["SWHealthLog"],{mode:"readwrite",O:!0},function(e){return Mk(e.objectStore("SWHealthLog"),{},function(f){if(f.getValue().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
...
;var tm=Oh("network_polling_interval",3E4);function um(){Te.call(this);var a=this;this.R=0;this.B=this.o=!1;this.l=this.Xa();M("use_shared_nsm")?(this.j=Ze(),M("use_shared_nsm_and_keep_yt_online_updated")&&(this.j.U("networkstatus-online",function(){a.l=!0;a.B&&sm()}),this.j.U("networkstatus-offline",function(){a.l=!1}))):(vm(this),wm(this))}
...
l=um.prototype;l.H=function(){if(M("use_shared_nsm")&&this.j){var a;return null==(a=this.j)?void 0:a.H()}return this.l};
l.aa=function(a){if(M("use_shared_nsm")&&this.j){var b;null!=(b=this.j)&&(b.j=a)}else a!==this.l&&(this.l=a)};
l.Yb=function(a){!M("use_shared_nsm")&&(this.o=!0,void 0===a?0:a)&&(this.R||ym(this))};
l.Xa=function(){var a=window.navigator.onLine;return void 0===a?!0:a};
l.Qb=function(){this.B=!0};
l.U=function(a,b){return M("use_shared_nsm")&&this.j?this.j.U(a,b):Te.prototype.U.call(this,a,b)};
function wm(a){window.addEventListener("online",function(){return w(function(b){if(1==b.i)return t(b,a.ca(),2);a.B&&sm();b.i=0})})}
function vm(a){window.addEventListener("offline",function(){return w(function(b){return t(b,a.ca(),0)})})}
function ym(a){a.R=Hj(function(){return w(function(b){if(1==b.i)return a.l?a.Xa()||!a.o?b.u(3):t(b,a.ca(),3):t(b,a.ca(),3);ym(a);b.i=0})},tm)}
l.ca=function(a){var b=this;if(M("use_shared_nsm")&&this.j){var c=Xe(this.j,a);c.then(function(d){M("use_cfr_monitor")&&om().requestComplete("generate_204",d)});
...
signal:g}),5);case 5:h=!0;case 3:za(k);M("use_cfr_monitor")&&om().requestComplete("generate_204",h);b.v=void 0;b.N&&$e.S(b.N);h!==b.l&&(b.l=h,b.l&&b.o?Ue(b,"ytnetworkstatus-online"):b.o&&Ue(b,"ytnetworkstatus-offline"));d(h);Aa(k);break;case 2:ya(k),h=!1,k.u(3)}})})};
um.prototype.sendNetworkCheckRequest=um.prototype.ca;um.prototype.listen=um.prototype.U;um.prototype.enableErrorFlushing=um.prototype.Qb;um.prototype.getWindowStatus=um.prototype.Xa;um.prototype.monitorNetworkStatusChange=um.prototype.Yb;um.prototype.networkStatusHint=um.prototype.aa;um.prototype.isNetworkAvailable=um.prototype.H;um.getInstance=xm;function zm(a){a=void 0===a?{}:a;Te.call(this);var b=this;this.l=this.N=0;this.o="ytnetworkstatus-offline";this.v="ytnetworkstatus-online";M("use_shared_nsm")&&(this.o="networkstatus-offline",this.v="networkstatus-online");this.j=xm();var c=A("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.j);c&&c(a.pb);a.xb&&(c=A("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.j))&&c();if(c=A("yt.networkStatusManager.instance.listen").bind(this.j))a.Qa?(this.Qa=a.Qa,c(this.v,
...
r(zm,Te);zm.prototype.H=function(){var a=A("yt.networkStatusManager.instance.isNetworkAvailable");return a?a.bind(this.j)():!0};
zm.prototype.aa=function(a){var b=A("yt.networkStatusManager.instance.networkStatusHint").bind(this.j);b&&b(a)};
zm.prototype.ca=function(a){var b=this,c;return w(function(d){c=A("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.j);return M("skip_network_check_if_cfr")&&om().isEndpointCFR("generate_204")?d.return(new Promise(function(e){var f;b.aa((null==(f=window.navigator)?void 0:f.onLine)||!0);e(b.H())})):c?d.return(c(a)):d.return(!0)})};
function Am(a,b){a.Qa?a.l?($e.S(a.N),a.N=$e.M(function(){a.B!==b&&(Ue(a,b),a.B=b,a.l=P())},a.Qa-(P()-a.l))):(Ue(a,b),a.B=b,a.l=P()):Ue(a,b)}
;var Bm;function Cm(){wl.call(this,{K:{Nb:cm,ma:bm,sb:Zl,Xb:$l,fb:am,set:Xl},J:Dm(),handleError:Uh,na:Vh,ba:Em,now:P,Ib:rm,T:Mj(),eb:"publicytnetworkstatus-online",cb:"publicytnetworkstatus-offline",Ia:!0,Ha:.1,Oa:Oh("potential_esf_error_limit",10),F:M,ta:!(ak()&&Fm())});this.l=new yd;M("networkless_immediately_drop_all_requests")&&dm();vl("LogsDatabaseV2")}
r(Cm,wl);function Gm(){var a=A("yt.networklessRequestController.instance");a||(a=new Cm,z("yt.networklessRequestController.instance",a),M("networkless_logging")&&kl().then(function(b){a.A=b;xl(a);a.l.resolve();a.Ia&&Math.random()<=a.Ha&&a.A&&hm(a.A);M("networkless_immediately_drop_sw_health_store")&&Hm(a)}));
return a}
...
function Em(a,b,c){M("use_cfr_monitor")&&Im(a,b);var d;if(null==(d=b.postParams)?0:d.requestTimeMs)b.postParams.requestTimeMs=Math.round(P());c&&0===Object.keys(b).length?lm(a):ui(a,b)}
function Dm(){Bm||(Bm=new zm({xb:!0,pb:!0}));return Bm}
...
function Om(){var a;w(function(b){switch(b.i){case 1:return t(b,kl(),2);case 2:a=b.j;if(!a||!ak()&&!M("nwl_init_require_datasync_id_killswitch")||!Fm()){b.u(0);break}Jm=!0;Nm.isNwlInitialized=Jm;if(!M("use_new_nwl_initialization")){b.u(4);break}return t(b,Gm().awaitInitialization(),5);case 5:return b.return();case 4:return t(b,vl("LogsDatabaseV2"),6);case 6:if(!(.1>=Math.random())){b.u(7);break}return t(b,cm(a),8);case 8:return t(b,hm(a),7);case 7:Pm();Qm().H()&&Rm();Qm().U("publicytnetworkstatus-online",
Rm);Qm().U("publicytnetworkstatus-offline",Sm);if(!M("networkless_immediately_drop_sw_health_store")){b.u(10);break}return t(b,Tm(),10);case 10:if(M("networkless_immediately_drop_all_requests"))return t(b,dm(),0);b.u(0)}})}
function Um(a,b){function c(d){var e=Qm().H();if(!Vm()||!d||e&&M("vss_networkless_bypass_write"))Wm(a,b);else{var f={url:a,options:b,timestamp:P(),status:"NEW",sendCount:0};Xl(f,d).then(function(g){f.id=g;Qm().H()&&Xm(f)}).catch(function(g){Xm(f);
Qm().H()?Uh(g):rm(g)})}}
...
e.options.onSuccess=function(k,m){M("use_cfr_monitor")&&om().requestComplete(e.url,!0);void 0!==e.id?bm(e.id,d):f=!0;M("vss_network_hint")&&Qm().aa(!0);g(k,m)};
...
Xl(e,d).then(function(k){e.id=k;f&&bm(e.id,d)}).catch(function(k){Qm().H()?Uh(k):rm(k)})}else Wm(a,b)}
b=void 0===b?{}:b;M("skip_is_supported_killswitch")?kl().then(function(d){c(d)}):c(jl())}
function Rm(){var a=jl();if(!a)throw pk("throttleSend");Km||(Km=$e.M(function(){var b;return w(function(c){if(1==c.i)return t(c,Zl("NEW",a),2);if(3!=c.i)return b=c.j,b?t(c,Xm(b),3):(Sm(),c.return());Km&&(Km=0,Rm());c.i=0})},100))}
function Sm(){$e.S(Km);Km=0}
...
a.options.onError=function(e,f){var g,h,k;return w(function(m){switch(m.i){case 1:M("use_cfr_monitor")&&om().requestComplete(a.url,!1);g=Dl(f);if(!(M("nwl_consider_error_code")&&g||!M("nwl_consider_error_code")&&an()<=Oh("potential_esf_error_limit",10))){m.u(2);break}if(M("skip_checking_network_on_cfr_failure")&&(!M("skip_checking_network_on_cfr_failure")||om().isEndpointCFR(a.url))){m.u(3);break}return t(m,Qm().ca(),3);case 3:if(Qm().H()){m.u(2);break}c(e,f);if(!M("nwl_consider_error_code")||void 0===
(null==(h=a)?void 0:h.id)){m.u(6);break}return t(m,am(a.id,b,!1),6);case 6:return m.return();case 2:if(M("nwl_consider_error_code")&&!g&&an()>Oh("potential_esf_error_limit",10))return m.return();A("ytNetworklessLoggingInitializationOptions")&&Nm.potentialEsfErrorCounter++;Lm++;if(void 0===(null==(k=a)?void 0:k.id)){m.u(8);break}return 1>a.sendCount?t(m,am(a.id,b),12):t(m,bm(a.id,b),8);case 12:$e.M(function(){Qm().H()&&Rm()},5E3);
case 8:c(e,f),m.i=0}})};
var d=a.options.onSuccess?a.options.onSuccess:function(){};
a.options.onSuccess=function(e,f){var g;return w(function(h){if(1==h.i)return M("use_cfr_monitor")&&om().requestComplete(a.url,!0),void 0===(null==(g=a)?void 0:g.id)?h.u(2):t(h,bm(a.id,b),2);M("vss_network_hint")&&Qm().aa(!0);d(e,f);h.i=0})};
return a}
function Zm(a,b){a=a.timestamp;return P()-a>=b?!1:!0}
function Pm(){var a=jl();if(!a)throw pk("retryQueuedRequests");Zl("QUEUED",a).then(function(b){b&&!Zm(b,12E4)?$e.M(function(){return w(function(c){if(1==c.i)return void 0===b.id?c.u(2):t(c,am(b.id,a),2);Pm();c.i=0})}):Qm().H()&&Rm()})}
...
function Qm(){if(M("use_new_nwl"))return Dm();Mm||(Mm=new zm({xb:!0,pb:!0}));return Mm}
function Wm(a,b,c){c&&0===Object.keys(b).length?lm(a):ui(a,b)}
...
adNotify:!0,adNotifyFilled:!0,tvhtml5LaunchUrlComponentChanged:!0,bedrockResourceConsumptionSnapshot:!0,deviceStartupMetrics:!0,mdxSignIn:!0,tvhtml5KeyboardLogging:!0,tvhtml5StartupSoundEvent:!0,tvhtml5LiveChatStatus:!0,tvhtml5DeviceStorageStatus:!0,tvhtml5LocalStorage:!0,directSignInEvent:!0,finalPayload:!0,tvhtml5SearchCompleted:!0,tvhtml5KeyboardPerformance:!0,adNotifyFailure:!0,latencyActionSpan:!0,tvhtml5AccountDialogOpened:!0,tvhtml5ApiTest:!0};var en=0,fn=vc?"webkit":uc?"moz":sc?"ms":rc?"o":"";z("ytDomDomGetNextId",A("ytDomDomGetNextId")||function(){return++en});var gn={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
;var pn=window.ytcsi&&window.ytcsi.now?window.ytcsi.now:window.performance&&window.performance.timing&&window.performance.now&&window.performance.timing.navigationStart?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};function qn(a){this.L=a;this.j=null;this.o=0;this.B=null;this.v=0;this.l=[];for(a=0;4>a;a++)this.l.push(0);this.m=0;this.R=nn(window,"mousemove",Wa(this.W,this));a=Wa(this.N,this);"function"===typeof a&&(a=Th(a));this.da=window.setInterval(a,25)}
Ya(qn,J);qn.prototype.W=function(a){void 0===a.i&&jn(a);var b=a.i;void 0===a.j&&jn(a);this.j=new Hd(b,a.j)};
qn.prototype.N=function(){if(this.j){var a=pn();if(0!=this.o){var b=this.B,c=this.j,d=b.x-c.x;b=b.y-c.y;d=Math.sqrt(d*d+b*b)/(a-this.o);this.l[this.m]=.5<Math.abs((d-this.v)/this.v)?1:0;for(c=b=0;4>c;c++)b+=this.l[c]||0;3<=b&&this.L();this.v=d}this.o=a;this.B=this.j;this.m=(this.m+1)%4}};
qn.prototype.I=function(){window.clearInterval(this.da);on(this.R)};var rn={};
function sn(a){var b=void 0===a?{}:a;a=void 0===b.cc?!1:b.cc;b=void 0===b.Rb?!0:b.Rb;if(null==A("_lact",window)){var c=parseInt(L("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;z("_lact",c,window);z("_fact",c,window);-1==c&&tn();nn(document,"keydown",tn);nn(document,"keyup",tn);nn(document,"mousedown",tn);nn(document,"mouseup",tn);a?nn(window,"touchmove",function(){un("touchmove",200)},{passive:!0}):(nn(window,"resize",function(){un("resize",200)}),b&&nn(window,"scroll",function(){un("scroll",200)}));
new qn(function(){un("mouse",100)});
nn(document,"touchstart",tn,{passive:!0});nn(document,"touchend",tn,{passive:!0})}}
function un(a,b){rn[a]||(rn[a]=!0,$e.M(function(){tn();rn[a]=!1},b))}
...
a?zo.i=b:yo.i=b}oi(a?zo.j:yo.j);b=L("LOGGING_BATCH_TIMEOUT",Oh("web_gel_debounce_ms",1E4));M("shorten_initial_gel_batch_timeout")&&Ao&&(b=Wn);b=ni(function(){Jo({writeThenSend:!0},void 0,a)},b);
a?zo.j=b:yo.j=b}
function Mo(a,b,c,d,e){var f=wo;d=void 0===d?{}:d;var g=Math.round(P()),h=a.size;a=q(a);for(var k=a.next();!k.done;k=a.next()){var m=q(k.value);k=m.next().value;var p=m.next().value;m=k;k=vb({context:qj(f.config_||pj())});k.events=p;(p=Do[m])&&Po(k,m,p);delete Do[m];m="visitorOnlyApprovedKey"===m;Qo(k,g,m);Ro(d);p=function(){h--;h||b()};
var u=function(){h--;h||b()};
try{Fj(f,"log_event",k,So(d,m,p,u,e)),Ao=!1}catch(y){Uh(y),c()}}}
function Oo(a,b,c,d){var e=wo;c=void 0===c?{}:c;var f=Math.round(P()),g=a.size;a=q(a);for(var h=a.next();!h.done;h=a.next()){var k=q(h.value);h=k.next().value;var m=k=k.next().value;k=new Eh;var p=vj(e.config_||pj());D(k,1,p);m=To(m);for(p=0;p<m.length;p++)pd(k,3,yh,m[p]);(m=Eo[h])&&Uo(k,h,m);delete Eo[h];h="visitorOnlyApprovedKey"===h;Vo(k,f,h);Ro(c);a:{Xc=!0;try{var u=JSON.stringify(k.toJSON(),ud);break a}finally{Xc=!1}u=void 0}k=u;h=So(c,h,function(){g--;g||b()},function(){g--;
g||b()},d);
...
function So(a,b,c,d,e){return{retry:!0,onSuccess:c,onError:d,yb:a,sa:b,ep:!!e,headers:{},postBodyFormat:"",postBody:""}}
...
function Yo(a,b,c,d){d=void 0===d?{}:d;if(M("lr_drop_other_and_business_payloads")){if(dn[a]||cn[a])return}else if(M("lr_drop_other_payloads")&&dn[a])return;var e={},f=Math.round(d.timestamp||P());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=vn();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};M("log_sequence_info_on_gel_web")&&d.V&&(a=e.context,b=d.V,b={index:Zo(b),groupKey:b},a.sequence=b,d.qb&&delete Xo[d.V]);(d.lc?Lo:Fo)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,
sa:d.sa},c)}
...
;var ap=[{bb:function(a){return"Cannot read property '"+a.key+"'"},
...
Na:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var cp={fa:[],ea:[{ia:bp,weight:500}]};function bp(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function dp(){this.ea=[];this.fa=[]}
var ep;function fp(){if(!ep){var a=ep=new dp;a.fa.length=0;a.ea.length=0;cp.fa&&a.fa.push.apply(a.fa,cp.fa);cp.ea&&a.ea.push.apply(a.ea,cp.ea)}return ep}
...
;var mp=x.ytLoggingGelSequenceIdObj_||{};z("ytLoggingGelSequenceIdObj_",mp);function np(a,b,c){c=void 0===c?{}:c;var d=Math.round(c.timestamp||P());C(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=vn();d=new xh;C(d,1,c.timestamp||!isFinite(e)?-1:e);if(M("log_sequence_info_on_gel_web")&&c.V){e=c.V;var f=Zo(e),g=new wh;C(g,2,f);C(g,1,e);D(d,3,g);c.qb&&delete mp[c.V]}D(a,33,d);(c.lc?No:Io)({endpoint:"log_event",payload:a,cttAuthInfo:c.cttAuthInfo,sa:c.sa},b)}
...
k.push("File name: "+a.fileName);k.push("Stacktrace: "+a.stack);window.console.log(k.join("\n"),a)}if(!(5<=wp)){var m=zp,p=re(a),u=p.message||"Unknown Error",y=p.name||"UnknownError",v=p.stack||a.j||"Not available";if(v.startsWith(y+": "+u)){var E=v.split("\n");E.shift();v=E.join("\n")}var F=p.lineNumber||"Not available",H=p.fileName||"Not available",R=v,O=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var S=0;S<a.args.length&&!(O=jp(a.args[S],"params."+S,g,O),500<=O);S++);else if(a.hasOwnProperty("params")&&
...
":"+Ca);if("IGNORED"===a.level)var ua=0;else a:{for(var Gn=fp(),Hn=q(Gn.fa),vi=Hn.next();!vi.done;vi=Hn.next()){var In=vi.value;if(G.message&&G.message.match(In.lp)){ua=In.weight;break a}}for(var Jn=q(Gn.ea),wi=Jn.next();!wi.done;wi=Jn.next()){var Kn=wi.value;if(Kn.ia(G)){ua=Kn.weight;break a}}ua=1}G.sampleWeight=ua;for(var Ln=q(ap),xi=Ln.next();!xi.done;xi=Ln.next()){var yi=xi.value;if(yi.Na[G.name])for(var Mn=q(yi.Na[G.name]),zi=Mn.next();!zi.done;zi=Mn.next()){var Nn=zi.value,Nf=G.message.match(Nn.regexp);
if(Nf){G.params["params.error.original"]=Nf[0];for(var Ai=Nn.groups,On={},Uc=0;Uc<Ai.length;Uc++)On[Ai[Uc]]=Nf[Uc+1],G.params["params.error."+Ai[Uc]]=Nf[Uc+1];G.message=yi.bb(On);break}}}G.params||(G.params={});var Pn=fp();G.params["params.errorServiceSignature"]="msg="+Pn.fa.length+"&cb="+Pn.ea.length;G.params["params.serviceWorker"]="false";x.document&&x.document.querySelectorAll&&(G.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Cb("sample").constructor!==
Ab&&(G.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(G);if(0!==G.sampleWeight&&!vp.has(G.message)){if("ERROR"===h){gp.ha("handleError",G);if(M("record_app_crashed_web")&&0===yp&&1===G.sampleWeight)if(yp++,M("errors_via_jspb")){var Bi=new $g;C(Bi,1,1);if(!M("report_client_error_with_app_crash_ks")){var Qn=new Vg;C(Qn,1,G.message);var Rn=new Wg;D(Rn,3,Qn);var Sn=new Xg;D(Sn,5,Rn);var Tn=new Yg;D(Tn,9,Sn);D(Bi,4,Tn)}var Un=new yh;od(Un,20,zh,Bi);op(Un)}else{var Vn=
{appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(Vn.systemHealth={crashData:{clientError:{logMessage:{message:G.message}}}});Xj("appCrashed",Vn)}xp++}else"WARNING"===h&&gp.ha("handleWarning",G);if(M("kevlar_gel_error_routing"))a:{var Td=h;if(M("errors_via_jspb")){if(Dp())var Xn=void 0;else{var Vc=new Sg;C(Vc,1,G.stack);G.fileName&&C(Vc,4,G.fileName);var qb=G.lineNumber&&G.lineNumber.split?G.lineNumber.split(":"):[];0!==qb.length&&(1!==qb.length||isNaN(Number(qb[0]))?
2!==qb.length||isNaN(Number(qb[0]))||isNaN(Number(qb[1]))||(C(Vc,2,Number(qb[0])),C(Vc,3,Number(qb[1]))):C(Vc,2,Number(qb[0])));var jc=new Vg;C(jc,1,G.message);C(jc,3,G.name);C(jc,6,G.sampleWeight);"ERROR"===Td?C(jc,2,2):"WARNING"===Td?C(jc,2,1):C(jc,2,0);var Ci=new Tg;C(Ci,1,!0);od(Ci,3,Ug,Vc);var Kb=new Pg;C(Kb,3,window.location.href);for(var Yn=L("FEXP_EXPERIMENTS",[]),Di=0;Di<Yn.length;Di++){var mt=Yn[Di];Zc(Kb);jd(Kb,5).push(mt)}var Ei=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Mh()&&Ei)for(var Zn=
q(Object.keys(Ei)),kc=Zn.next();!kc.done;kc=Zn.next()){var $n=kc.value,Fi=new Rg;C(Fi,1,$n);Fi.setValue(String(Ei[$n]));pd(Kb,4,Rg,Fi)}var Gi=G.params;if(Gi){var ao=q(Object.keys(Gi));for(kc=ao.next();!kc.done;kc=ao.next()){var bo=kc.value,Hi=new Rg;C(Hi,1,"client."+bo);Hi.setValue(String(Gi[bo]));pd(Kb,4,Rg,Hi)}}var co=L("SERVER_NAME"),eo=L("SERVER_VERSION");if(co&&eo){var Ii=new Rg;C(Ii,1,"server.name");Ii.setValue(co);pd(Kb,4,Rg,Ii);var Ji=new Rg;C(Ji,1,"server.version");Ji.setValue(eo);pd(Kb,
4,Rg,Ji)}var Of=new Wg;D(Of,1,Kb);D(Of,2,Ci);D(Of,3,jc);Xn=Of}var fo=Xn;if(!fo)break a;var go=new yh;od(go,163,zh,fo);op(go)}else{if(Dp())var ho=void 0;else{var Ud={stackTrace:G.stack};G.fileName&&(Ud.filename=G.fileName);var rb=G.lineNumber&&G.lineNumber.split?G.lineNumber.split(":"):[];0!==rb.length&&(1!==rb.length||isNaN(Number(rb[0]))?2!==rb.length||isNaN(Number(rb[0]))||isNaN(Number(rb[1]))||(Ud.lineNumber=Number(rb[0]),Ud.columnNumber=Number(rb[1])):Ud.lineNumber=Number(rb[0]));var Ki={level:"ERROR_LEVEL_UNKNOWN",
message:G.message,errorClassName:G.name,sampleWeight:G.sampleWeight};"ERROR"===Td?Ki.level="ERROR_LEVEL_ERROR":"WARNING"===Td&&(Ki.level="ERROR_LEVEL_WARNNING");var nt={isObfuscated:!0,browserStackInfo:Ud},Wc={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(Wc.experimentIds=L("FEXP_EXPERIMENTS"));var Li=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Mh()&&Li)for(var io=q(Object.keys(Li)),lc=io.next();!lc.done;lc=io.next()){var jo=lc.value;Wc.kvPairs.push({key:jo,value:String(Li[jo])})}var Mi=
G.params;if(Mi){var ko=q(Object.keys(Mi));for(lc=ko.next();!lc.done;lc=ko.next()){var lo=lc.value;Wc.kvPairs.push({key:"client."+lo,value:String(Mi[lo])})}}var mo=L("SERVER_NAME"),no=L("SERVER_VERSION");mo&&no&&(Wc.kvPairs.push({key:"server.name",value:mo}),Wc.kvPairs.push({key:"server.version",value:no}));ho={errorMetadata:Wc,stackTrace:nt,logMessage:Ki}}var oo=ho;if(!oo)break a;Xj("clientError",oo)}if("ERROR"===Td||M("errors_flush_gel_always_killswitch"))M("web_fp_via_jspb")&&$o(!0),$o()}if(!M("suppress_error_204_logging")){var Vd=
G.params||{},Lb={urlParams:{a:"logerror",t:"jserror",type:G.name,msg:G.message.substr(0,250),line:G.lineNumber,level:h,"client.name":Vd.name},postParams:{url:L("PAGE_NAME",window.location.href),file:G.fileName},method:"POST"};Vd.version&&(Lb["client.version"]=Vd.version);if(Lb.postParams){G.stack&&(Lb.postParams.stack=G.stack);for(var po=q(Object.keys(Vd)),Ni=po.next();!Ni.done;Ni=po.next()){var qo=Ni.value;Lb.postParams["client."+qo]=Vd[qo]}var Oi=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(Oi)for(var ro=
q(Object.keys(Oi)),Pi=ro.next();!Pi.done;Pi=ro.next()){var so=Pi.value;Lb.postParams[so]=Oi[so]}var to=L("SERVER_NAME"),uo=L("SERVER_VERSION");to&&uo&&(Lb.postParams["server.name"]=to,Lb.postParams["server.version"]=uo)}ui(L("ECATCHER_REPORT_HOST","")+"/error_204",Lb)}try{vp.add(G.message)}catch(Mu){}wp++}}}}
function Dp(){for(var a=q(Ap),b=a.next();!b.done;b=a.next())if(Oj(b.value.toLowerCase()))return!0;return!1}
function Ep(a){var b=Ja.apply(1,arguments);a.args||(a.args=[]);a.args.push.apply(a.args,fa(b))}
;function Fp(){this.register=new Map}
function Gp(a){a=q(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.qp("ABORTED")}
...
return a.join("")}
;var Kp=x.ytLoggingDocDocumentNonce_;Kp||(Kp=Jp(),z("ytLoggingDocDocumentNonce_",Kp));var Lp=Kp;var Mp={Bg:0,pd:1,zd:2,pk:3,Dg:4,Ao:5,il:6,Km:7,im:8,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS"};function Np(a){this.i=a}
...
;var $p={od:3611,Bc:27686,Cc:85013,Dc:23462,Fc:42016,Gc:62407,Hc:26926,Ec:43781,Ic:51236,Jc:79148,Kc:50160,Lc:77504,Xc:87907,Yc:18630,Zc:54445,bd:80935,cd:105675,dd:150723,ed:37521,fd:147285,gd:47786,hd:98349,jd:123695,kd:6827,ld:29434,md:7282,nd:124448,rd:32276,qd:76278,sd:147868,td:147869,ud:93911,vd:106531,wd:27259,xd:27262,yd:27263,Ad:21759,Bd:27107,Cd:62936,Dd:49568,Ed:38408,Fd:80637,Gd:68727,Hd:68728,Id:80353,Jd:80356,Kd:74610,Ld:45707,Md:83962,Nd:83970,Od:46713,Pd:89711,Qd:74612,Rd:93265,Sd:74611,
Td:131380,Vd:128979,Wd:139311,Xd:128978,Ud:131391,Yd:105350,ae:139312,be:134800,Zd:131392,de:113533,ee:93252,ge:99357,ie:94521,je:114252,ke:113532,le:94522,he:94583,me:88E3,ne:139580,oe:93253,pe:93254,qe:94387,re:94388,se:93255,te:97424,ce:72502,ue:110111,we:76019,ye:117092,ze:117093,xe:89431,Ae:110466,Be:77240,Ce:60508,De:148123,Ee:148124,Fe:137401,Ge:137402,He:137046,Ie:73393,Je:113534,Ke:92098,Le:131381,Me:84517,Ne:83759,Oe:80357,Pe:86113,Qe:72598,Re:72733,Se:107349,Te:124275,Ue:118203,Ve:133275,
We:133274,Xe:133272,Ye:133273,Ze:133276,af:144507,bf:143247,cf:143248,df:143249,ef:143250,ff:143251,gf:144401,jf:117431,hf:133797,kf:128572,lf:133405,mf:117429,nf:117430,pf:117432,qf:120080,rf:117259,sf:121692,tf:145656,uf:145655,vf:145653,wf:145654,xf:145657,yf:132972,zf:133051,Af:133658,Bf:132971,Cf:97615,Ef:143359,Df:143356,Gf:143361,Ff:143358,If:143360,Hf:143357,Jf:142303,Kf:143353,Lf:143354,Mf:144479,Nf:143355,Of:31402,Qf:133624,Rf:146477,Sf:133623,Tf:133622,Pf:133621,Uf:84774,Vf:95117,Wf:150497,
Xf:98930,Yf:98931,Zf:98932,ag:43347,cg:129889,dg:149123,eg:45474,fg:100352,gg:84758,hg:98443,ig:117985,jg:74613,kg:74614,lg:64502,mg:136032,ng:74615,og:74616,pg:122224,qg:74617,rg:77820,sg:74618,tg:93278,ug:93274,vg:93275,wg:93276,xg:22110,yg:29433,zg:133798,Ag:132295,Cg:120541,Eg:82047,Fg:113550,Gg:75836,Hg:75837,Ig:42352,Jg:84512,Kg:76065,Lg:75989,Qg:16623,Rg:32594,Sg:27240,Tg:32633,Ug:74858,Wg:3945,Vg:16989,Xg:45520,Yg:25488,Zg:25492,ah:25494,bh:55760,dh:14057,eh:18451,fh:57204,gh:57203,hh:17897,
ih:57205,jh:18198,kh:17898,lh:17909,mh:43980,nh:46220,oh:11721,ph:147994,qh:49954,rh:96369,sh:3854,th:151633,uh:56251,vh:25624,Mh:16906,Nh:99999,Oh:68172,Ph:27068,Qh:47973,Rh:72773,Sh:26970,Th:26971,Uh:96805,Vh:17752,Wh:73233,Xh:109512,Yh:22256,Zh:14115,ai:22696,bi:89278,ci:89277,di:109513,fi:43278,gi:43459,hi:43464,ii:89279,ji:43717,ki:55764,li:22255,mi:147912,ni:89281,oi:40963,ri:43277,si:43442,ti:91824,vi:120137,wi:96367,xi:36850,yi:72694,zi:37414,Ai:36851,Ci:124863,Bi:121343,Di:73491,Ei:54473,
Fi:43375,Gi:46674,Hi:143815,Ii:139095,Ji:144402,Ki:149968,Li:149969,Mi:32473,Ni:72901,Oi:72906,Pi:50947,Qi:50612,Ri:50613,Si:50942,Ti:84938,Ui:84943,Vi:84939,Wi:84941,Xi:84944,Yi:84940,Zi:84942,aj:35585,bj:51926,cj:79983,dj:63238,ej:18921,fj:63241,gj:57893,hj:41182,ij:135732,jj:33424,kj:22207,lj:42993,mj:36229,nj:22206,oj:22205,pj:18993,qj:19001,rj:18990,sj:18991,tj:18997,uj:18725,vj:19003,wj:36874,xj:44763,yj:33427,zj:67793,Aj:22182,Bj:37091,Cj:34650,Dj:50617,Ej:47261,Fj:22287,Gj:25144,Hj:97917,
Ij:62397,Jj:150871,Kj:150874,Lj:125598,Mj:137935,Nj:36961,Oj:108035,Pj:27426,Qj:27857,Rj:27846,Sj:27854,Tj:69692,Uj:61411,Vj:39299,Wj:38696,Xj:62520,Yj:36382,Zj:108701,ak:50663,bk:36387,ck:14908,dk:37533,ek:105443,fk:61635,gk:62274,hk:133818,ik:65702,jk:65703,kk:65701,lk:76256,mk:37671,nk:49953,qk:36216,rk:28237,sk:39553,tk:29222,uk:26107,vk:38050,wk:26108,yk:120745,xk:26109,zk:26110,Ak:66881,Bk:28236,Ck:14586,Dk:57929,Ek:74723,Fk:44098,Gk:44099,Jk:23528,Kk:61699,Hk:134104,Ik:134103,Lk:59149,Mk:101951,
Nk:97346,Ok:118051,Pk:95102,Qk:64882,Rk:119505,Sk:63595,Tk:63349,Uk:95101,Vk:75240,Wk:27039,Xk:68823,Yk:21537,Zk:83464,al:75707,bl:83113,dl:101952,fl:101953,jl:79610,kl:125755,ll:24402,ml:24400,nl:32925,ol:57173,pl:122502,ql:145268,rl:138480,sl:64423,ul:64424,vl:33986,wl:100828,xl:129089,yl:21409,Cl:135155,Dl:135156,El:135157,Fl:135158,Gl:135159,Hl:135160,Il:135161,Jl:135162,Kl:135163,Ll:135164,Ml:135165,Nl:135166,zl:11070,Al:11074,Bl:17880,Ol:14001,Ql:30709,Rl:30707,Sl:30711,Tl:30710,Ul:30708,Pl:26984,
Vl:146143,Wl:63648,Xl:63649,Yl:51879,Zl:111059,am:5754,bm:20445,cm:151152,em:130975,dm:130976,fm:110386,gm:113746,hm:66557,jm:17310,km:28631,lm:21589,mm:68012,nm:60480,om:138664,pm:141121,qm:31571,rm:141978,sm:150105,tm:150106,um:150107,vm:150108,wm:76980,xm:41577,ym:45469,zm:38669,Am:13768,Bm:13777,Cm:141842,Dm:62985,Em:4724,Fm:59369,Gm:43927,Hm:43928,Im:12924,Jm:100355,Mm:56219,Nm:27669,Om:10337,Lm:47896,Pm:122629,Rm:139723,Qm:139722,Sm:121258,Tm:107598,Um:127991,Vm:96639,Wm:107536,Xm:130169,Ym:96661,
Zm:145188,an:96658,bn:116646,cn:121122,dn:96660,en:127738,fn:127083,gn:147842,hn:104443,jn:96659,kn:147595,ln:106442,mn:134840,nn:63667,pn:63668,qn:63669,rn:130686,sn:147036,tn:78314,un:147799,vn:148649,wn:55761,xn:127098,yn:134841,zn:96368,An:67374,Bn:48992,Cn:146176,Dn:49956,En:31961,Fn:26388,Gn:23811,Hn:5E4,In:126250,Jn:96370,Kn:47355,Ln:47356,Mn:37935,Nn:45521,On:21760,Pn:83769,Qn:49977,Rn:49974,Sn:93497,Tn:93498,Un:34325,Vn:140759,Wn:115803,Xn:123707,Yn:100081,Zn:35309,ao:68314,bo:25602,co:100339,
eo:143516,fo:59018,ho:18248,jo:50625,ko:9729,lo:37168,mo:37169,no:21667,oo:16749,po:18635,qo:39305,ro:18046,so:53969,to:8213,uo:93926,vo:102852,wo:110099,xo:22678,yo:69076,zo:137575,Bo:139224,Co:100856,Do:17736,Eo:3832,Fo:147111,Go:55759,Ho:64031,No:93044,Oo:93045,Po:34388,Qo:17657,Ro:17655,So:39579,To:39578,Uo:77448,Vo:8196,Wo:11357,Xo:69877,Yo:8197,Zo:82039};function aq(){var a=ub(bq),b;return ag(new Uf(function(c,d){a.onSuccess=function(e){mi(e)?c(new cq(e)):d(new dq("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
;function hq(){if(ke()||Nj&&Oj("applewebkit")&&!Oj("version")&&(!Oj("safari")||Oj("gsa/"))||wc&&Oj("version/"))return!0;if(M("enable_web_eom_visitor_data"))return L("EOM_VISITOR_DATA")?!1:!0;var a=L("INNERTUBE_CLIENT_NAME");return!a||"WEB"!==a&&"MWEB"!==a?!0:(a=$i("CONSENT"))?a.startsWith("YES+"):!0}
...
function yq(a,b,c,d){d=void 0===d?!1:d;if(-1<c.indexOf(b))throw Error("Deps cycle for: "+b);if(a.i.has(b))return a.i.get(b);if(!a.providers.has(b)){if(d)return;throw Error("No provider for: "+b);}d=a.providers.get(b);c.push(b);if(d.Ac)var e=d.Ac;else if(d.zc)e=d[tq]?zq(a,d[tq],c):[],e=d.zc.apply(d,fa(e));else if(d.Hb){e=d.Hb;var f=e[tq]?zq(a,e[tq],c):[];e=new (Function.prototype.bind.apply(e,[null].concat(fa(f))))}else throw Error("Could not resolve providers for: "+b);c.pop();d.vp||a.i.set(b,e);
return e}
...
Eq.prototype.handleResponse=function(a,b){var c,d;b=(null==(c=b.Z.context)?void 0:null==(d=c.request)?void 0:d.consistencyTokenJars)||[];var e;if(a=null==(e=a.responseContext)?void 0:e.consistencyTokenJar){e=q(b);for(c=e.next();!c.done;c=e.next())delete this.i[c.value.encryptedTokenJarContents];Fq(this,a)}};
...
Hq.prototype.createUnpluggedLocationInfo=function(a){var b={};a=a.coords;if(null==a?0:a.latitude)b.latitudeE7=Math.floor(1E7*a.latitude);if(null==a?0:a.longitude)b.longitudeE7=Math.floor(1E7*a.longitude);if(null==a?0:a.accuracy)b.locationRadiusMeters=Math.round(a.accuracy);return b};function Kq(a,b){var c;if((null==(c=a.signalServiceEndpoint)?0:c.signal)&&b.xa&&(c=b.xa[a.signalServiceEndpoint.signal]))return c();var d;if((null==(d=a.continuationCommand)?0:d.request)&&b.Ob&&(d=b.Ob[a.continuationCommand.request]))return d();for(var e in a)if(b.lb[e]&&(a=b.lb[e]))return a()}
...
function Oq(a){var b=void 0===b?"UNKNOWN_INTERFACE":b;if(1===a.length)return a[0];var c=Nq[b];if(c){var d=new RegExp(c),e=q(a);for(c=e.next();!c.done;c=e.next())if(c=c.value,d.exec(c))return c}var f=[];Object.entries(Nq).forEach(function(g){var h=q(g);g=h.next().value;h=h.next().value;b!==g&&f.push(h)});
...
var H=q(Object.entries(E));for(var R=H.next();!R.done;R=H.next()){var O=q(R.value),S=O.next().value,ja=O.next().value;E=S;F=ja;d=void 0;null==(d=g.adSignalsInfo.params)||d.push({key:E,value:""+F})}}catch(Na){Bp(Na)}H=g}else Bp(Error("Error: No InnerTubeContext shell provided in ytconfig.")),H={};H={context:H};if(R=this.i(a)){this.j(H,R,b);var N;b="/youtubei/v1/"+Oq(this.l());var Ba;(a=null==(N=a.commandMetadata)?void 0:null==(Ba=N.webCommandMetadata)?void 0:Ba.apiUrl)&&(b=a);N=b;(Ba=L("INNERTUBE_HOST_OVERRIDE"))&&
(N=String(Ba)+String(dc(N)));Ba={};Ba.key=L("INNERTUBE_API_KEY");M("json_condensed_response")&&(Ba.prettyPrint="false");N=gi(N,Ba||{},!1);N={input:N,oa:Pq(N),Z:H,config:Object.assign({},void 0)};N.config.Ea?N.config.Ea.identity=c:N.config.Ea={identity:c};return N}Bp(new Q("Error: Failed to create Request from Command.",a))};
da.Object.defineProperties(Qq.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!1}}});function Rq(){}
r(Rq,Qq);Rq.prototype.s=function(){return{input:"/getDatasyncIdsEndpoint",oa:Pq("/getDatasyncIdsEndpoint","GET"),Z:{}}};
...
b=q(b);for(var c=b.next();!c.done;c=b.next())Wq(a,c.value);return a}
...
function Yq(a,b){b=q(b);for(var c=b.next();!c.done;c=b.next())c=c.value,Vq(c)?a.push(Wq({},c)):Xq(c)?a.push(Yq([],c)):a.push(c);return a}
...
function pr(a,b){for(var c=q(Object.keys(b)),d=c.next();!d.done;d=c.next())if(d=d.value,!Object.keys(a).includes(d)||"object"===typeof b[d]&&!pr(a[d],b[d]))return!1;return!0}
...
var Zr=window;Zr.ytcsi&&(Zr.ytcsi.info=Rr,Zr.ytcsi.tick=Z);var $r="tokens consistency mss client_location entities store".split(" ");function as(a,b,c,d){this.s=a;this.J=b;this.m=c;this.l=d;this.j=void 0;this.i=new Map;a.xa||(a.xa={});a.xa=Object.assign({},Tq,a.xa)}
function bs(a,b,c,d){if(void 0!==as.i){if(d=as.i,a=[a!==d.s,b!==d.J,c!==d.m,!1,!1,void 0!==d.j],a.some(function(e){return e}))throw new Q("InnerTubeTransportService is already initialized",a);
}else as.i=new as(a,b,c,d)}
function cs(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?Bq:c;var d=Kq(b,a.s);if(!d)return Zf(new Q("Error: No request builder found for command.",b));var e=d.s(b,void 0,c);return e?new Uf(function(f){var g,h,k;return w(function(m){if(1==m.i){h="cors"===(null==(g=e.oa)?void 0:g.mode)?"cors":void 0;if(a.m.wc){var p=e.config,u;p=null==p?void 0:null==(u=p.Ea)?void 0:u.sessionIndex;u=sq({sessionIndex:p});k=Object.assign({},ds(h),u);return m.u(2)}return t(m,es(e.config,
h),3)}2!=m.i&&(k=m.j);f(fs(a,e,k));m.i=0})}):Zf(new Q("Error: Failed to build request for command.",b))}
function fs(a,b,c){var d,e,f,g,h,k,m,p,u,y,v,E,F,H,R,O,S,ja;return w(function(N){switch(N.i){case 1:N.u(2);break;case 3:if((d=N.j)&&!d.isExpired())return N.return(Promise.resolve(d.i()));case 2:if((f=null==(e=b.config)?void 0:e.rp)&&a.i.has(f)&&M("web_memoize_inflight_requests"))return N.return(a.i.get(f));if(null==(g=b)?0:null==(h=g.Z)?0:h.context)for(k=q([]),m=k.next();!m.done;m=k.next())p=m.value,p.np(b.Z.context);if(null==(u=a.j)?0:u.up(b.input,b.Z))return N.return(a.j.kp(b.input,b.Z));y=JSON.stringify(b.Z);
b.oa=Object.assign({},b.oa,{headers:c});v=Object.assign({},b.oa);"POST"===b.oa.method&&(v=Object.assign({},v,{body:y}));(null==(E=b.config)?0:E.hc)&&Z(b.config.hc);F=a.J.fetch(b.input,v,b.config);f&&a.i.set(f,F);return t(N,F,4);case 4:H=N.j;f&&a.i.has(f)&&a.i.delete(f);(null==(R=b.config)?0:R.ic)&&Z(b.config.ic);if(H||null==(O=a.j)||!O.fp(b.input,b.Z)){N.u(5);break}return t(N,a.j.jp(b.input,b.Z),6);case 6:H=N.j;case 5:if(H&&a.l)for(S=q($r),m=S.next();!m.done;m=S.next())ja=m.value,a.l[ja]&&a.l[ja].handleResponse(H,
b);return N.return(H)}})}
function es(a,b){var c,d,e,f;return w(function(g){if(1==g.i){e=null==(c=a)?void 0:null==(d=c.Ea)?void 0:d.sessionIndex;var h=sq({sessionIndex:e});if(!(h instanceof Uf)){var k=new Uf(bb);Vf(k,2,h);h=k}return t(g,h,2)}f=g.j;return g.return(Promise.resolve(Object.assign({},ds(b),f)))})}
...
V:b};d=q(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(ob(g)||!g.trackingParams&&!g.veType)&&Cp(Error("Child VE logged with no data"));if(M("il_via_jspb")){var h=new hh;h.P(b);jh(h,c.getAsJspb());gb(e,function(k){k=k.getAsJspb();pd(h,3,bh,k)});
...
function xs(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return Lc(b,3)}
function Cs(a,b,c){ws.push({payloadName:a,payload:b,options:c});zs||(zs=Ol())}
function Pl(a){if(ws){for(var b=q(ws),c=b.next();!c.done;c=b.next()){var d=c.value;if(d.payload)if(M("il_via_jspb"))switch(d.payload.P(a.csn),d.payloadName){case "screenCreated":sp(d.payload,d.options);break;case "visualElementAttached":tp(d.payload,d.options);break;case "visualElementShown":c=d.payload;d=d.options;var e=new yh;od(e,72,zh,c);op(e,d);break;case "visualElementHidden":pp(d.payload,d.options);break;case "visualElementGestured":qp(d.payload,d.options);break;case "visualElementStateChanged":rp(d.payload,
...
Es.prototype.clickCommand=function(a,b,c){var d=a.clickTrackingParams;c=void 0===c?0:c;if(d)if(c=Up(void 0===c?0:c)){a=this.client;var e=Op(d);var f="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";d={cttAuthInfo:Wp(c),V:c};if(M("il_via_jspb")){var g=new kh;g.P(c);e=e.getAsJspb();D(g,2,e);C(g,4,Ah[f]);b&&D(g,3);"UNDEFINED_CSN"==c?Cs("visualElementGestured",g,d):qp(g,d,a)}else f={csn:c,ve:e.getAsJson(),gestureType:f},b&&(f.clientData=b),"UNDEFINED_CSN"==c?Cs("visualElementGestured",f,d):a?Yo("visualElementGestured",
f,a,d):Xj("visualElementGestured",f,d);b=!0}else b=!1;else b=!1;return b};
function Hs(a,b,c){c=void 0===c?{}:c;a.j.add(c.layer||0);a.l=function(){Is(a,b,c);var f=Sp(c.layer);if(f){for(var g=q(a.s),h=g.next();!h.done;h=g.next())h=h.value,Gs(a,h[0],h[1]||f,c.layer);f=q(a.D);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=Up(g);var m=k[0]||Sp(g);if(h&&m){g=a.client;var p=k[1];k={cttAuthInfo:Wp(h),V:h};M("il_via_jspb")?(p=new mh,p.P(h),m=m.getAsJspb(),D(p,2,m),"UNDEFINED_CSN"==h?Cs("visualElementStateChanged",p,k):rp(p,k,g)):(m={csn:h,ve:m.getAsJson(),
clientData:p},"UNDEFINED_CSN"==h?Cs("visualElementStateChanged",m,k):g?Yo("visualElementStateChanged",m,g,k):Xj("visualElementStateChanged",m,k))}}}};
Up(c.layer)||a.l();if(c.ob)for(var d=q(c.ob),e=d.next();!e.done;e=d.next())Fs(a,e.value,c.layer);else Bp(Error("Delayed screen needs a data promise."))}
function Is(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.ac?c.ac:c.layer;var e=Up(d);d=Sp(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=L("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=As(a.client,b,f,c.nb,c.cttAuthInfo,g,c.ip)}catch(m){Ep(m,{sp:b,rootVe:d,parentVisualElement:void 0,gp:e,mp:f,nb:c.nb});Bp(m);return}Xp(k,b,
c.layer,c.cttAuthInfo);if(b=e&&"UNDEFINED_CSN"!==e&&d){a:{b=q(Object.values(Mp));for(f=b.next();!f.done;f=b.next())if(Up(f.value)===e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:Wp(e),V:e,qb:g},M("il_via_jspb")?(h=new lh,h.P(e),d=d.getAsJspb(),D(h,2,d),C(h,4,g?16:8),"UNDEFINED_CSN"==e?Cs("visualElementHidden",h,f):pp(h,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"==e?Cs("visualElementHidden",d,f):b?Yo("visualElementHidden",d,b,f):Xj("visualElementHidden",
d,f)));a.i[a.i.length-1]&&!a.i[a.i.length-1].csn&&(a.i[a.i.length-1].csn=k||"");Qr({clientScreenNonce:k});Ds.getInstance().clear();d=Sp(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(M("web_mark_root_visible")||M("music_web_mark_root_visible"))&&(e={cttAuthInfo:Wp(k),V:k},M("il_via_jspb")?(b=new lh,b.P(k),f=d.getAsJspb(),D(b,2,f),C(b,4,1),"UNDEFINED_CSN"==k?Cs("visualElementShown",b,e):(k=new yh,od(k,72,zh,b),op(k,e))):(b={csn:k,ve:d.getAsJson(),eventType:1},"UNDEFINED_CSN"==k?Cs("visualElementShown",b,e):
Xj("visualElementShown",b,e)));a.j.delete(c.layer||0);a.l=void 0;e=q(a.v);for(k=e.next();!k.done;k=e.next())b=q(k.value),k=b.next().value,b=b.next().value,b.has(c.layer)&&d&&Gs(a,k,d,c.layer);for(c=0;c<a.m.length;c++){e=a.m[c];try{e()}catch(m){Bp(m)}}for(c=a.m.length=0;c<a.o.length;c++){e=a.o[c];try{e()}catch(m){Bp(m)}}}
;function Js(){var a,b;return w(function(c){if(1==c.i)return a=as.i,a?t(c,cs(a),2):(Cp(Error("InnertubeTransportService unavailable in fetchDatasyncIds")),c.return(void 0));if(b=c.j)return b.errorMetadata?(Cp(Error("Datasync IDs fetch responded with "+b.errorMetadata.status+": "+b.error)),c.return(void 0)):c.return(b.hp);Cp(Error("Network request to get Datasync IDs failed."));return c.return(void 0)})}
;var Ks=x.caches,Ls;function Ms(a){var b=a.indexOf(":");return-1===b?{zb:a}:{zb:a.substring(0,b),datasyncId:a.substring(b+1)}}
...
return a.return(Ls)})}
function Os(a){var b,c,d,e,f,g,h;w(function(k){if(1==k.i)return t(k,Ns(),2);if(3!=k.i){if(!k.j)return k.return(!1);b=[];return t(k,Ks.keys(),3)}c=k.j;d=q(c);for(e=d.next();!e.done;e=d.next())f=e.value,g=Ms(f),h=g.datasyncId,!h||a.includes(h)||b.push(Ks.delete(f));return k.return(Promise.all(b).then(function(m){return m.some(function(p){return p})}))})}
function Ps(){var a,b,c,d,e,f,g;return w(function(h){if(1==h.i)return t(h,Ns(),2);if(3!=h.i){if(!h.j)return h.return(!1);a=bk("cache contains other");return t(h,Ks.keys(),3)}b=h.j;c=q(b);for(d=c.next();!d.done;d=c.next())if(e=d.value,f=Ms(e),(g=f.datasyncId)&&g!==a)return h.return(!0);return h.return(!1)})}
;function Qs(){try{return!!self.localStorage}catch(a){return!1}}
;function Rs(a){a=a.match(/(.*)::.*::.*/);if(null!==a)return a[1]}
function Ss(a){if(Qs()){var b=Object.keys(window.localStorage);b=q(b);for(var c=b.next();!c.done;c=b.next()){c=c.value;var d=Rs(c);void 0===d||a.includes(d)||self.localStorage.removeItem(c)}}}
function Ts(){if(!Qs())return!1;var a=bk(),b=Object.keys(window.localStorage);b=q(b);for(var c=b.next();!c.done;c=b.next())if(c=Rs(c.value),void 0!==c&&c!==a)return!0;return!1}
;function Us(){Js().then(function(a){a&&(ml(a),Os(a),Ss(a))})}
function Vs(){var a=new zm;$e.M(function(){var b,c,d,e;return w(function(f){switch(f.i){case 1:if(M("ytidb_clear_optimizations_killswitch")){f.u(2);break}b=bk("clear");if(b.startsWith("V")){var g=[b];ml(g);Os(g);Ss(g);return f.return()}c=Ts();return t(f,Ps(),3);case 3:return d=f.j,t(f,nl(),4);case 4:if(e=f.j,!c&&!d&&!e)return f.return();case 2:a.H()?Us():a.m.add("publicytnetworkstatus-online",Us,!0,void 0,void 0),f.i=0}})})}
...
var et={};var jt=[],kt=!1;function lt(){if(!M("disable_biscotti_fetch_for_ad_blocker_detection")&&!M("disable_biscotti_fetch_entirely_for_all_web_clients")&&hq()){var a=L("PLAYER_VARS",{});if(!("1"==sb(a)||M("embeds_web_disable_ads_for_pfl")&&"EMBEDDED_PLAYER_MODE_PFL"===iq(a))){var b=function(){kt=!0;"google_ad_status"in window?Lh("DCLKSTAT",1):Lh("DCLKSTAT",2)};
try{bt("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}jt.push($e.M(function(){if(!(kt||"google_ad_status"in window)){try{ht("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}kt=!0;Lh("DCLKSTAT",3)}},5E3))}}}
function ot(){var a=Number(L("DCLKSTAT",0));return isNaN(a)?0:a}
;function pt(){this.state=1;this.i=null}
pt.prototype.initialize=function(a,b,c){if(a.program){var d,e=null!=(d=a.interpreterScript)?d:null,f;d=null!=(f=a.interpreterUrl)?f:null;a.interpreterSafeScript&&(e=a.interpreterSafeScript,Cb("From proto message. b/166824318"),e=e.privateDoNotAccessOrElseSafeScriptWrappedValue||"",e=(f=zb())?f.createScript(e):e,e=(new Eb(e)).toString());a.interpreterSafeUrl&&(d=a.interpreterSafeUrl,Cb("From proto message. b/166824318"),d=Ib(d.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue||"").toString());
qt(this,e,d,a.program,b,c)}else Cp(Error("Cannot initialize botguard without program"))};
...
pt.prototype.isInitialized=function(){return!!this.i};
function rt(a,b,c,d){a.state=5;try{var e=new zd({program:b,globalName:c});e.tc.then(function(){a.state=6;d&&d(b)});
st(a,e)}catch(f){a.state=7,f instanceof Error&&Cp(f)}}
pt.prototype.invoke=function(a){a=void 0===a?{}:a;if(this.i){var b=this.i;a={mb:a};if(b.j)throw Error("Already disposed");b=b.m([a.mb,a.vc])}else b=null;return b};
pt.prototype.dispose=function(){st(this,null);this.state=8};
...
;function wt(a){var b=this;var c=void 0===c?0:c;var d=void 0===d?Mj():d;this.m=c;this.l=d;this.j=new yd;this.i=a;a={};c=q(this.i.entries());for(d=c.next();!d.done;a={qa:a.qa,za:a.za},d=c.next()){var e=q(d.value);d=e.next().value;e=e.next().value;a.za=d;a.qa=e;d=function(f){return function(){f.qa.ab();b.i[f.za].Pa=!0;b.i.every(function(g){return!0===g.Pa})&&b.j.resolve()}}(a);
e=Ij(d,xt(this,a.qa));this.i[a.za]=Object.assign({},a.qa,{ab:d,La:e})}}
function zt(a){var b=Array.from(a.i.keys()).sort(function(d,e){return xt(a,a.i[e])-xt(a,a.i[d])});
b=q(b);for(var c=b.next();!c.done;c=b.next())c=a.i[c.value],void 0===c.La||c.Pa||(a.l.S(c.La),Ij(c.ab,10))}
wt.prototype.cancel=function(){for(var a=q(this.i),b=a.next();!b.done;b=a.next())b=b.value,void 0===b.La||b.Pa||this.l.S(b.La),b.Pa=!0;this.j.resolve()};
...
f=f.map(function(k){var m;return{ab:function(){k.ia.apply(k,fa(d))},
...
Et.prototype.install=function(){var a=Ja.apply(0,arguments);this.i.install.apply(this.i,fa(a));this.j.install.apply(this.j,fa(a))};function Ft(){Et.call(this);var a={};this.install((a.document_disposed={ia:this.l},a));a={};this.install((a.flush_logs={ia:this.m},a))}
var Gt;r(Ft,Et);Ft.prototype.m=function(){if(M("web_fp_via_jspb")){var a=new ah,b=Up();b&&a.P(b);b=new yh;od(b,380,zh,a);op(b);M("web_fp_via_jspb_and_json")&&Xj("finalPayload",{csn:Up()})}else Xj("finalPayload",{csn:Up()})};
...
;function Lt(a,b,c){J.call(this);var d=this;c=c||L("POST_MESSAGE_ORIGIN")||window.document.location.protocol+"//"+window.document.location.hostname;this.l=b||null;this.targetOrigin="*";this.m=c;this.sessionId=null;this.channel="widget";this.L=!!a;this.B=function(e){a:if(!("*"!=d.m&&e.origin!=d.m||d.l&&e.source!=d.l||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.L&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
r(Lt,J);Lt.prototype.sendMessage=function(a,b){if(b=b||this.l){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.targetOrigin)}catch(d){Vh(d)}}};
Lt.prototype.I=function(){window.removeEventListener("message",this.B);J.prototype.I.call(this)};function Mt(){this.j=[];this.isReady=!1;this.l={};var a=this.i=new Lt(!!L("WIDGET_ID_ENFORCE")),b=this.ec.bind(this);a.o=b;a.v=null;this.i.channel="widget";if(a=L("WIDGET_ID"))this.i.sessionId=a}
l=Mt.prototype;l.ec=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.l[a]||"onReady"===a||(this.addEventListener(a,Nt(this,a)),this.l[a]=!0)):this.hb(a,b,c)};
l.hb=function(){};
function Nt(a,b){return function(c){return a.sendMessage(b,c)}}
l.addEventListener=function(){};
l.Sb=function(){this.isReady=!0;this.sendMessage("initialDelivery",this.Va());this.sendMessage("onReady");eb(this.j,this.Fb,this);this.j=[]};
l.Va=function(){return null};
function Ot(a,b){a.sendMessage("infoDelivery",b)}
l.Fb=function(a){this.isReady?this.i.sendMessage(a):this.j.push(a)};
l.sendMessage=function(a,b){this.Fb({event:a,info:void 0===b?null:b})};
...
;function St(a){Mt.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.pc.bind(this));this.addEventListener("onVolumeChange",this.qc.bind(this));this.addEventListener("onApiChange",this.jc.bind(this));this.addEventListener("onPlaybackQualityChange",this.mc.bind(this));this.addEventListener("onPlaybackRateChange",this.nc.bind(this));this.addEventListener("onStateChange",this.oc.bind(this));this.addEventListener("onWebglSettingsChanged",
this.sc.bind(this))}
r(St,Mt);l=St.prototype;
l.hb=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Pt(a)){var d=b;if(Qa(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=Qt(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=Qt(e);break;case "loadPlaylist":case "cuePlaylist":e=Rt(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);Pt(a)&&Ot(this,this.Va())}};
l.onReady=function(){var a=this.Sb.bind(this);this.i.j=a};
l.addEventListener=function(a,b){this.listeners.push({eventType:a,listener:b});this.api.addEventListener(a,b)};
l.Va=function(){if(!this.api)return null;var a=this.api.getApiInterface();jb(a,"getVideoData");for(var b={apiInterface:a},c=0,d=a.length;c<d;c++){var e=a[c];if(0===e.search("get")||0===e.search("is")){var f=0;0===e.search("get")?f=3:0===e.search("is")&&(f=2);f=e.charAt(f).toLowerCase()+e.substr(f+1);try{var g=this.api[e]();b[f]=g}catch(h){}}}b.videoData=this.api.getVideoData();b.currentTimeLastUpdated_=Date.now()/1E3;return b};
l.oc=function(a){a={playerState:a,currentTime:this.api.getCurrentTime(),duration:this.api.getDuration(),videoData:this.api.getVideoData(),videoStartBytes:0,videoBytesTotal:this.api.getVideoBytesTotal(),videoLoadedFraction:this.api.getVideoLoadedFraction(),playbackQuality:this.api.getPlaybackQuality(),availableQualityLevels:this.api.getAvailableQualityLevels(),currentTimeLastUpdated_:Date.now()/1E3,playbackRate:this.api.getPlaybackRate(),mediaReferenceTime:this.api.getMediaReferenceTime()};this.api.getVideoUrl&&
...
l.mc=function(a){Ot(this,{playbackQuality:a})};
l.nc=function(a){Ot(this,{playbackRate:a})};
l.jc=function(){for(var a=this.api.getOptions(),b={namespaces:a},c=0,d=a.length;c<d;c++){var e=a[c],f=this.api.getOptions(e);b[e]={options:f};for(var g=0,h=f.length;g<h;g++){var k=f[g],m=this.api.getOption(e,k);b[e][k]=m}}this.sendMessage("apiInfoDelivery",b)};
l.qc=function(){Ot(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
l.pc=function(a){a={currentTime:a,videoBytesLoaded:this.api.getVideoBytesLoaded(),videoLoadedFraction:this.api.getVideoLoadedFraction(),currentTimeLastUpdated_:Date.now()/1E3,playbackRate:this.api.getPlaybackRate(),mediaReferenceTime:this.api.getMediaReferenceTime()};this.api.getProgressState&&(a.progressState=this.api.getProgressState());Ot(this,a)};
l.sc=function(){var a={sphericalProperties:this.api.getSphericalProperties()};Ot(this,a)};
l.dispose=function(){Mt.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function Tt(a){J.call(this);this.j={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.Bb,this)}
r(Tt,J);l=Tt.prototype;l.start=function(){this.started||this.i()||(this.started=!0,this.connection.ja("RECEIVING"))};
l.ja=function(a,b){this.started&&!this.i()&&this.connection.ja(a,b)};
l.Bb=function(a,b,c){if(this.started&&!this.i()){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&this.addListener(d.event);break;case "removeEventListener":"string"===typeof d.event&&this.removeListener(d.event);break;default:this.api.isReady()&&this.api.isExternalMethodAvailable(a,c||null)&&(b=Ut(a,b||{}),c=this.api.handleExternalCall(a,b,c||null),(c=Vt(a,c))&&this.ja(a,c))}}};
l.addListener=function(a){if(!(a in this.j)){var b=this.kc.bind(this,a);this.j[a]=b;this.addEventListener(a,b)}};
l.kc=function(a,b){this.started&&!this.i()&&this.connection.ja(a,this.Ua(a,b))};
l.Ua=function(a,b){if(null!=b)return{value:b}};
l.removeListener=function(a){a in this.j&&(this.removeEventListener(a,this.j[a]),delete this.j[a])};
l.I=function(){var a=this.connection;a.i()||lg(a.j,"command",this.Bb,this);this.connection=null;for(var b in this.j)this.j.hasOwnProperty(b)&&this.removeListener(b);J.prototype.I.call(this)};function Wt(a,b){Tt.call(this,b);this.api=a;this.start()}
...
Wt.prototype.Ua=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Tt.prototype.Ua.call(this,a,b)};
Wt.prototype.I=function(){Tt.prototype.I.call(this);delete this.api};function Xt(a){a=void 0===a?!1:a;J.call(this);this.j=new K(a);pe(this,Xa(ne,this.j))}
Ya(Xt,J);Xt.prototype.subscribe=function(a,b,c){return this.i()?0:this.j.subscribe(a,b,c)};
Xt.prototype.m=function(a,b){this.i()||this.j.ha.apply(this.j,arguments)};function Yt(a,b,c){Xt.call(this);this.l=a;this.destination=b;this.id=c}
r(Yt,Xt);Yt.prototype.ja=function(a,b){this.i()||this.l.ja(this.destination,this.id,a,b)};
Yt.prototype.I=function(){this.destination=this.l=null;Xt.prototype.I.call(this)};function Zt(a,b,c){J.call(this);this.destination=a;this.origin=c;this.j=nn(window,"message",this.l.bind(this));this.connection=new Yt(this,a,b);pe(this,Xa(ne,this.connection))}
r(Zt,J);Zt.prototype.ja=function(a,b,c,d){this.i()||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(Mf(a),this.origin))};
...
r(fu,J);fu.prototype.I=function(){for(;this.j.length;){var a=this.j.pop();a.target.removeEventListener(a.name,a.ia,void 0)}J.prototype.I.call(this)};function gu(){fu.apply(this,arguments)}
r(gu,fu);function hu(a,b,c,d){J.call(this);var e=this;this.N=b;this.webPlayerContextConfig=d;this.Ra=!1;this.api={};this.Ba=this.v=null;this.R=new K;this.j={};this.da=this.Ca=this.elementId=this.Sa=this.config=null;this.W=!1;this.m=this.B=null;this.Da={};this.Jb=["onReady"];this.lastError=null;this.ib=NaN;this.L={};this.Kb=new gu(this);this.la=0;this.l=this.o=a;pe(this,Xa(ne,this.R));iu(this);ju(this);pe(this,Xa(ne,this.Kb));c?this.la=ni(function(){e.loadNewVideoConfig(c)},0):d&&(ku(this),lu(this))}
r(hu,J);l=hu.prototype;l.getId=function(){return this.N};
l.loadNewVideoConfig=function(a){if(!this.i()){this.la&&(oi(this.la),this.la=0);var b=a||{};b instanceof $t||(b=new $t(b));this.config=b;this.setConfig(a);lu(this);this.isReady()&&mu(this)}};
...
function lu(a){if(!a.i()&&!a.W){var b=pu(a);if(b&&"html5"===(qu(a)?"html5":null))a.da="html5",a.isReady()||su(a);else if(tu(a),a.da="html5",b&&a.m&&a.o)a.o.appendChild(a.m),su(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.B=function(){c=!0;var d=uu(a,"player_bootstrap_method")?A("yt.player.Application.createAlternate")||A("yt.player.Application.create"):A("yt.player.Application.create");var e=a.config?nu(a.config):void 0;d&&d(a.o,e,a.webPlayerContextConfig);su(a)};
a.W=!0;b?a.B():(bt(ru(a),a.B),(b=vu(a))&&bu(b),wu(a)&&!c&&z("yt.player.Application.create",null))}}}
function qu(a){var b=Jd(a.elementId);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.elementId));return b}
function su(a){if(!a.i()){var b=qu(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);if(c){a.W=!1;if(!uu(a,"html5_remove_not_servable_check_killswitch")){var d;if((null==b?0:b.isNotServable)&&a.config&&(null==b?0:b.isNotServable(null==(d=a.config.args)?void 0:d.video_id)))return}xu(a)}else a.ib=ni(function(){su(a)},50)}}
function xu(a){iu(a);a.Ra=!0;var b=qu(a);if(b){a.v=yu(a,b,"addEventListener");a.Ba=yu(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=yu(a,b,f))}}for(var g in a.j)a.j.hasOwnProperty(g)&&a.v&&a.v(g,a.j[g]);mu(a);a.Ca&&a.Ca(a.api);a.R.ha("onReady",a.api)}
...
function iu(a){a.Ra=!1;if(a.Ba)for(var b in a.j)a.j.hasOwnProperty(b)&&a.Ba(b,a.j[b]);for(var c in a.L)a.L.hasOwnProperty(c)&&oi(Number(c));a.L={};a.v=null;a.Ba=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
l.isReady=function(){return this.Ra};
...
l.addEventListener=function(a,b){var c=this,d=ou(this,b);d&&(0<=db(this.Jb,a)||this.j[a]||(b=zu(this,a),this.v&&this.v(a,b)),this.R.subscribe(a,d),"onReady"===a&&this.isReady()&&ni(function(){d(c.api)},0))};
l.removeEventListener=function(a,b){this.i()||(b=ou(this,b))&&lg(this.R,a,b)};
function ou(a,b){var c=b;if("string"===typeof b){if(a.Da[b])return a.Da[b];c=function(){var d=Ja.apply(0,arguments),e=A(b);if(e)try{e.apply(x,d)}catch(f){Bp(f)}};
a.Da[b]=c}return c?c:null}
function zu(a,b){var c="ytPlayer"+b+a.N;a.j[b]=c;x[c]=function(d){var e=ni(function(){if(!a.i()){a.R.ha(b,null!=d?d:void 0);var f=a.L,g=String(e);g in f&&delete f[g]}},0);
pb(a.L,String(e))};
return c}
l.getPlayerType=function(){return this.da||(qu(this)?"html5":null)};
l.getLastError=function(){return this.lastError};
function tu(a){a.cancel();iu(a);a.da=null;a.config&&(a.config.loaded=!1);var b=qu(a);b&&(pu(a)||!wu(a)?a.m=b:(b&&b.destroy&&b.destroy(),a.m=null));if(a.o)for(a=a.o;b=a.firstChild;)a.removeChild(b)}
l.cancel=function(){this.B&&ht(ru(this),this.B);oi(this.ib);this.W=!1};
l.I=function(){tu(this);if(this.m&&this.config&&this.m.destroy)try{this.m.destroy()}catch(b){Bp(b)}this.Da=null;for(var a in this.j)this.j.hasOwnProperty(a)&&(x[this.j[a]]=null);this.Sa=this.config=this.api=null;delete this.o;delete this.l;J.prototype.I.call(this)};
...
function nu(a){for(var b={},c=q(Object.keys(a)),d=c.next();!d.done;d=c.next()){d=d.value;var e=a[d];b[d]="object"===typeof e?ub(e):e}return b}
...
lt();M("ytidb_create_logger_embed_killswitch")||Uj();a={};Gt||(Gt=new Ft);Gt.install((a.flush_logs={ia:function(){Jo()}},a));
M("networkless_logging_web_embedded")&&(M("embeds_web_enable_new_nwl")?Gm():Om());M("ytidb_clear_embedded_player")&&$e.M(function(){var e;if(!us){Aq||(Aq=new xq);var f=Aq;var g={dc:ts,Hb:ss};f.providers.set(g.dc,g);g={lb:{feedbackEndpoint:Lq(os),modifyChannelNotificationPreferenceEndpoint:Lq(ps),playlistEditEndpoint:Lq(qs),subscribeEndpoint:Lq(ms),unsubscribeEndpoint:Lq(ns),webPlayerShareEntityServiceEndpoint:Lq(rs)}};var h=M("web_enable_client_location_service")?Hq.getInstance():void 0,k={};h&&(k.client_location=
